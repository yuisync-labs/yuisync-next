...
const generatedUrl = new URL('./.run-full-staging-certification-v30.generated.mjs', import.meta.url)
...
if (!source.includes(expectedSchemaMarker) || !source.includes(checkNameMarker)) {
  throw new Error('STAGING_CERTIFICATION_V30_PATCH_MARKERS_MISSING')
}

const patched = source
  .replace(expectedSchemaMarker, "const expectedSchema = '30'")
  .replace(checkNameMarker, "await record('schema_v30'")
