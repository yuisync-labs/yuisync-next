...
-- 0017 has a legacy CHECK(entitlements_json) constraint. JSON scalar 1 is the
-- only canonical compatibility marker we need here; browser features live in
-- the dedicated JSON-array `features` column added above.
